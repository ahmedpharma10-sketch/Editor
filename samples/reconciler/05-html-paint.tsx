 ...
 *
 * The left <rect> is an ECS entity. Inside <html> (long form <htmlPaint>),
 * <rect> is an SVG element (namespace inherited from <svg>), <div> is plain
 * HTML, and the counter text updates reactively in the drawn DOM. Note the
 * type-level approximation: shared tag names keep their composition prop
 * types everywhere, so the SVG <rect> below sticks to numeric props that
 * satisfy both sides.
 */
...
export default () => (
  <scene key="sample-html" name="HTML paint" width={960} height={540} fill="#101014">
    ...
    <rect x={280} y={60} width={640} height={420}>
      <html>
