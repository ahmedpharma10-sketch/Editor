...
| `color` | `string` | white | The glyph color; any CSS color, alpha ignored (use `opacity`). Drawn beneath any paint children (see [paints.md](./paints.md)); animate it with a `color` [keyframe track](./keyframes.md). |
...
```tsx
<text fontSize={96} color="#FFFFFF" textAlign="center" textBaseline="middle">
  Ship it today
