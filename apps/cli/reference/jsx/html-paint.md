...
Inside `<Html>`, every lowercase tag is a DOM element — the case decides the environment: PascalCase tags are composition elements, lowercase tags are HTML/SVG. Lowercase tags remain invalid outside `<Html>` content.
