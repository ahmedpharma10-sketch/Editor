...
import { Background, DEFAULT_BACKGROUND } from "@diffusionstudio/runtime";
...
export function BackgroundSettings() {
  ...
  const background = useTrait(world, Background);
  const color = () => background()?.value ?? DEFAULT_BACKGROUND;


  let anchorRef: HTMLDivElement | undefined;

  const assignColor = (value: number) => world.set(Background, { value });
