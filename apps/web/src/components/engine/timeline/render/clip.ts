...
import { getParentEntity, hasSurfacePaint, hasHtmlPaint, isAdjustmentLayer, isCaption, isGroup, isMask, isScene, isText } from "../../api";
...
export function getClipStyle(
  ...
  if (hasHtmlPaint(world, eid) || hasSurfacePaint(world, eid)) {
